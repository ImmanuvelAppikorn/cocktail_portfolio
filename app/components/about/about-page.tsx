...
export default function AboutPage({
  ...
  return (
    <div
      className="relative w-full h-screen overflow-hidden mt-[20px] flex flex-col items-center max-h-screen max-w-[500px] mx-auto"
...
<motion.div
      ...
      {/* Paragraph */}
      <p className="text-[14px] w-[95%] font-axiforma tracking-[1px]  font-medium mt-1 leading-7 text-left px-4">
