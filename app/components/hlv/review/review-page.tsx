  ...
  return (
    <>
      ...
      >
        ...
        <div className=" space-y-2 flex-shrink-0">
          <div className="flex flex-wrap justify-between items-center w-full ">
            ...
            <div className="flex-shrink-0">
              <button
                className="bg-[#5E7ECC] px-2 py-1 rounded-full flex items-center text-white text-[11px] sm:text-[11px] font-bold gap-1 sm:gap-2 hover:bg-[#1A2042] transition whitespace-nowrap"
        ...
        <div className="flex-shrink-0  absolute bottom-[13%] left-1/2 -translate-x-1/2 w-full h-[150px] ">
          <BottleCarousel />
        </div>
      </div>
