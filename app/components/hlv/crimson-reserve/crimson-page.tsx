  ...
  return (
    <div className=" relative flex flex-col pt-2 px-4 h-full  text-black overflow-y-auto w-full max-w-[500px] mx-auto">
      <AnimatePresence>
        ...
        >
          <button
            className="relative cursor-pointer overflow-hidden inline-flex items-center justify-center  px-4 py-2 rounded-[56px] text-black text-[12px] font-montagu font-semibold bg-gradient-to-t border-1 border-[#1A2042] from-[#5e7dcc00] to-[#5E7ECC] hover:opacity-90 transition group"
        ...
        >
          ...
          <div className="flex flex-col gap-4 text-[12px] font-semibold mt-6">
            <div className="flex flex-row w-full justify-between">
              <InfoCard
                half
                icon="/assets/vite_colte/crimson-reserve-icons/origin.svg"
                title="ORIGIN"
                value="ITALY"
              />
              <InfoCard
                half
                icon="/assets/vite_colte/crimson-reserve-icons/vintage.svg"
                title="VINTAGE"
                value="-"
              />
            </div>
            <div className="flex flex-row w-full justify-between">
              <InfoCard
                half
                icon="/assets/vite_colte/crimson-reserve-icons/region.svg"
                title="REGION"
                value="PIEDMONT"
              />
              <InfoCard
                half
                icon="/assets/vite_colte/crimson-reserve-icons/variety.svg"
                title="VARIETY"
                value="RUCHE"
              />
            </div>
