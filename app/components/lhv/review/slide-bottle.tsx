...
const bottles = [
  {
    ...
    name: "VERMOUTH ROSSO",
    price: "20,00",
    img: "/assets/lhv/vinea/image-1.svg",
    color: "#5E7ECC",
  },
  {
    id: 2,
    name: "ALTA LANGA",
    price: "27,00",
    img: "/assets/lhv/vinea/image-2.svg",
    color: "#897746",
  },
  {
    id: 3,
    name: "ROSE BRUT",
    price: "22,00",
    img: "/assets/lhv/vinea/image-3.svg",
    color: "#E3AE5D",
  },
  {
    id: 4,
    name: "MOSCATO D'ASTI CANELLI",
    price: "12,00",
    img: "/assets/lhv/vinea/image-4.svg",
    color: "#716004",
  },
  {
    id: 5,
    name: "ACINO BLU",
    price: "12,00",
    img: "/assets/lhv/vinea/image-5.svg",
    color: "#413102",
  },
];
          ...
          <div className="relative top-2 w-full h-[400px] left-1/2 transform -translate-x-1/2 flex items-center justify-center overflow-visible max-w-[500px]">
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 0.6, ease: "easeInOut" }}
              >
                <div className="bg-white w-[80%] h-[80%] rounded-full blur-[80px]"/>
              </motion.div>
            </motion.div>
          </div>
        </div>
