...
export default function HomePage() {
  ...
  return (
    <div
      className="relative flex flex-col items-center justify-start bg-[#ffffff] overflow-hidden max-w-[500px] mx-auto h-screen"
      style={{ height: "100vh" }}
    >
      {/* Navigation Bar */}
      ...
      <AnimatePresence>
        {currentStep === "home" && !reverse && !showIntro && (
          <div className="absolute top-[5%] z-20 w-[90%] aspect-[3/1] flex items-center justify-center overflow-hidden">
            <motion.h1
              ...
              transition={smoothTransition}
            >
              <div className="relative w-[80%] aspect-[2.2/1] mx-auto">
                <Image
                  fill
                  priority
                  alt="Vinea Logo"
                  className="object-contain"
                  src="/assets/lhv/logo/logo.svg"
                />
              </div>
            </motion.h1>
          </div>
      ...
      <AnimatePresence>
        {currentStep === "home" && !reverse && !showIntro && (
          ...
          >
            <button
              className="relative cursor-pointer overflow-hidden inline-flex items-center justify-center border-1  px-4 py-2 rounded-[56px] text-black text-[12px] font-montagu font-semibold bg-gradient-to-t border-[#1A2042] from-[#5e7dcc5d] to-[#5E7ECC] hover:opacity-90 transition group"
            ...
            >
              ...
              <Image
                ...
                className="ml-2 z-10"
                height={14}
                src="/assets/lhv/button-image/arrow-up-right-black.svg"
                width={14}
              />
            </button>
          </motion.div>
      ...
      >
        <div className="relative w-full h-full">
          <Image
            ...
            alt="bottle"
            className="object-contain"
            src="/assets/lhv/vinea/image-1.svg"
          />
        </div>
      </motion.div>
      ...
      >
        <Image
          ...
          height={1000}
          src="/assets/lhv/shape-svg/circle-shape.svg"
          width={1000}
        />
      </motion.div>
      ...
      {currentStep !== "home" && !reverse && (
        <motion.div
          className="absolute top-[35%] right-4 z-50 cursor-pointer shadow-[0_0_6px_0px_rgba(0,0,0,0.25)] rounded-full"
          drag
          dragMomentum={false}
          dragElastic={0.2}
          onClick={() => {
        ...
        >
          <Image
            src="/assets/lhv/navigation-bar/ingredients.svg"
